...
const theme = createTheme({
  palette: {
    ...
    text: {
      ...
      secondary: `${BRAND_COLORS.text}CC`
    },
    success: {
      main: BRAND_COLORS.level4
    },
  ...
  typography: {
    ...
    h1: { fontWeight: 700, color: BRAND_COLORS.text },
    h2: { fontWeight: 600, color: BRAND_COLORS.text },
    h3: { fontWeight: 600, color: BRAND_COLORS.text },
    h4: { fontWeight: 600, color: BRAND_COLORS.text },
    h5: { fontWeight: 600, color: BRAND_COLORS.text },
    h6: { fontWeight: 600, color: BRAND_COLORS.text },
    body1: { color: BRAND_COLORS.text },
    body2: { color: BRAND_COLORS.text }
  },
  components: {
    MuiButton: {
      styleOverrides: {
